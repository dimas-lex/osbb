...
(function(t, n, r) {
    ...
    var e = function(n, e) {
        ...
        var s, o = this;
        o.element = n, o.options = t.extend({}, t.fn.bsAlerts.defaults, e), t(r).on("add-alerts", function() {
    ...
    t.fn.bsAlerts = function(n) {
        return this.each(function() {
            var r = t(this),
                a = r.data("bsAlerts"),
                i = "object" == typeof n && n;
            a || r.data("bsAlerts", a = new e(this, i)), "string" == typeof n && a[n]()
        })
    }, t.fn.bsAlerts.Constructor = e, t.fn.bsAlerts.defaults = {
        titles: {},
        ids: "",
        fade: "0"
    }, t.fn.bsAlerts.noConflict = function() {
        return t.fn.bsAlerts = a, this
    }, t(r).ready(function() {
